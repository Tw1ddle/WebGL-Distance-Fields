...
@:native("THREE.TexturePass") extern class TexturePass {
	public function new(scene:Scene, camera:Camera, overrideMaterial:Material, clearColor:Color, clearAlpha:Bool):Void;
	public function render(renderer:WebGLRenderer, writeBuffer:Dynamic, readBuffer:Dynamic, delta:Float):Void;
